---
description: "Automation-only Agent Client Protocol server for programmatic clients and maintainers driving Xingyunxunzhi agents over JSON-RPC stdio."
