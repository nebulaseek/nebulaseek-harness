...
function webSurfacePrompt(webUrl: string): string {
  ...
  return `You are interacting with the user through the Xingyunxunzhi Web GUI at ${webUrl}. `
  ...
  if (config.surfaceContext) {
    ...
    ctx.inject(['shellEnv'], (runtimeCtx) => {
      runtimeCtx.shellEnv.register({
        name: 'web-runtime',
        variables: {
          [DSH_WEB_URL]: { description: 'Canonical local URL of the Xingyunxunzhi Web GUI serving this session.' },
        },
