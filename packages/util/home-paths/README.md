---
description: "Shared resolution of the Xingyunxunzhi home and user-data paths for packages that need one consistent root, tilde expansion, and stable watch paths."
