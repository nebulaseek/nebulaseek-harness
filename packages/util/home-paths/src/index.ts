/**
 * Shared filesystem path helpers for Xingyunxunzhi user data.
 *
...
/** Directory name for the default Xingyunxunzhi home under the OS home. */
export const DSH_HOME_DIR_NAME = '.dsh'

/** Stable user-facing display form for the default Xingyunxunzhi home. */
export const DEFAULT_DSH_HOME_DISPLAY = `~/${DSH_HOME_DIR_NAME}`

/** Environment variable that overrides the default Xingyunxunzhi home. */
...
/**
 * Resolve the default Xingyunxunzhi home using Node's platform path rules.
...
/**
 * Resolve the single-root Xingyunxunzhi home.
 *
...
/**
 * Join path segments onto the resolved Xingyunxunzhi home.
