---
description: "The model-facing todo_write tool over the Xingyunxunzhi session log: whole-list replacement, per-session ownership, and the todos projection, for users and maintainers choosing, configuring, or debugging the tool."
