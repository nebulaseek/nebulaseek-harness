...
export const en = {
  ...
  welcomeBody: "XingYunXunZhi Harness 0.1 remains in testing for Harness developers. It follows the DeepSeek Harness community upstream and keeps downstream changes limited to visible branding. Core plugins and foundational APIs will continue to evolve rapidly with upstream.\n\nWe look forward to exploring the limits of intelligence with developers around the world, building on open-source, open, reusable, and composable infrastructure. We welcome Harness developers everywhere to join the DSH plugin ecosystem.",
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  creating: '创建中\u2026',
  welcomeTitle: '内测声明',
  welcomeBody: '星云寻知 0.1 目前仍处在面向 Harness 开发者的测试阶段。本项目跟随 DeepSeek Harness 社区上游，下游改动仅限用户可见品牌；核心插件与基础 API 将随上游持续快速演进。\n\n我们期待与全球开发者一起，在开源、开放、可复用、可组合的基础设施之上，共同探索智能上限。欢迎全球 Harness 开发者加入 DSH 插件生态。',
  welcomeContinue: '继续',
