...
/**
 * The hero brand mark (34px wide), rendered when no brand plugin occupies the
 * slot. Hovering floats it in place through the stylesheet's hover rule on the
 * hitbox; reduced motion and coarse pointers keep it still. Decorative —
 * hidden from the accessibility tree.
 * @returns the mark svg element.
 */
function HeroMark() {
  return <BrandLogo size={34} className={css.mark} />
}
    ...
    <div className={css.root}>
      <div className={css.stack}>
        <div className={css.headline}>
          {/* figma 34:10412: brand mark 34 wide leading the headline, gap 10. */}
