...
LangString INSTALLER_LAUNCH_FAILED ${LANG_ENGLISH} "XingYunXunZhi Harness could not be launched. Retry, or clear Launch now and close the installer."
...
LangString INSTALLER_RUNNING ${LANG_ENGLISH} "XingYunXunZhi Harness is running. Close the application, then run this installer again."
...
LangString INSTALLER_PATH_OWNERSHIP ${LANG_ENGLISH} "Choose an empty folder or the registered XingYunXunZhi Harness installation folder."
