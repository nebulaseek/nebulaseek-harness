...
LangString INSTALLER_LAUNCH_FAILED ${LANG_ENGLISH} "NebulaSeek（星云寻知） Harness could not be launched. Retry, or clear Launch now and close the installer."
LangString INSTALLER_LAUNCH_FAILED ${LANG_SIMPCHINESE} "无法启动星云寻知。请重试，或取消勾选立即启动后关闭安装程序。"
...
LangString INSTALLER_RUNNING ${LANG_ENGLISH} "NebulaSeek（星云寻知） Harness is running. Close the application, then run this installer again."
LangString INSTALLER_RUNNING ${LANG_SIMPCHINESE} "星云寻知正在运行。请先关闭应用，再重新运行安装程序。"
...
LangString INSTALLER_PATH_OWNERSHIP ${LANG_ENGLISH} "Choose an empty folder or the registered NebulaSeek（星云寻知） Harness installation folder."
LangString INSTALLER_PATH_OWNERSHIP ${LANG_SIMPCHINESE} "请选择空文件夹，或星云寻知原来的安装目录。"
