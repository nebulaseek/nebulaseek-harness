...
export const en = {
  ...
  startupFailed: 'Xingyunxunzhi could not start',
...
export const zh = {
  ...
  updateDetail: '星云寻知 {version}\n\n新版本绑定匹配的 dsh，安装后将重新启动。',
  installAndRestart: '安装并重启',
  later: '稍后',
  updateFailedTitle: '更新失败',
  pluginManagerTitle: '桌面插件',
  pluginWindowTitle: '星云寻知 — 桌面插件',
