...
export const en = {
  ...
  startupFailed: 'NebulaSeek is unavailable',
  ...
  updateDownloadedTitle: 'NebulaSeek v{version} downloaded',
...
export const zh = {
  ...
  updateDownload: '下载更新',
  updateDownloadedTitle: 'NebulaSeek v{version} 下载完成',
