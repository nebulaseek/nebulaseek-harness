...
export const en = {
  ...
  aboutMenu: 'About NebulaSeek（星云寻知） Harness',
  edit: 'Edit',
  ...
  startupFailed: 'NebulaSeek（星云寻知） Harness is unavailable',
  ...
  updateDownloadedTitle: 'NebulaSeek（星云寻知） Harness v{version} downloaded',
...
export const zh = {
  ...
  updateDownload: '下载更新',
  updateDownloadedTitle: '星云寻知 v{version} 下载完成',
