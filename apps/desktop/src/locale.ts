...
export const en = {
  ...
  aboutMenu: 'About XingYunXunZhi Harness',
  edit: 'Edit',
  ...
  startupFailed: 'XingYunXunZhi Harness is unavailable',
  ...
  updateDownloadedTitle: 'XingYunXunZhi Harness v{version} downloaded',
