...
const REPOSITORY_URL = 'https://github.com/xingyunxunzhi/xingyunxunzhi-harness'
...
function githubTarget(
  ...
  if (image) return `https://raw.githubusercontent.com/xingyunxunzhi/xingyunxunzhi-harness/${repositoryRef}/${path}${suffix}`
