# Xingyunxunzhi Python SDK

English | [中文](README.zh.md)

Python subprocess SDK for driving Xingyunxunzhi over newline-delimited JSON-RPC on stdio. Install `deepseek-harness-sdk`; it installs the exact same-version `deepseek-harness-runtime-bin` wheel for the current platform.
