...
Python packages for driving Xingyunxunzhi as a subprocess. The client SDK communicates with the bundled runtime over newline-delimited JSON-RPC on stdio.
